...
public struct TwitterLocalizations {
    ...
    static let FetchErrorFormat = NSLocalizedString("There was an error fetching from Twitter: %@", comment: "There was an error fetching: We failed you and we're sorry")
